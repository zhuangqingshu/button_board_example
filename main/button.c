...
#define LIGHT_GROUP_ID                    (13)
#define DEVICE_TID                        (13)
...
void app_main()
{
    ...
    MDF_ERROR_ASSERT(mlink_add_characteristic(DEVICE_CID_KEY0, "key_0", CHARACTERISTIC_FORMAT_INT, CHARACTERISTIC_PERMS_RT, 1, 2, 1));
    MDF_ERROR_ASSERT(mlink_add_characteristic(DEVICE_CID_KEY1, "key_1", CHARACTERISTIC_FORMAT_INT, CHARACTERISTIC_PERMS_RT, 1, 2, 1));
    MDF_ERROR_ASSERT(mlink_add_characteristic(DEVICE_CID_KEY2, "key_2", CHARACTERISTIC_FORMAT_INT, CHARACTERISTIC_PERMS_RT, 1, 2, 1));
    MDF_ERROR_ASSERT(mlink_add_characteristic(DEVICE_CID_KEY3, "key_3", CHARACTERISTIC_FORMAT_INT, CHARACTERISTIC_PERMS_RT, 1, 2, 1));
	MDF_ERROR_ASSERT(mlink_add_characteristic(DEVICE_CID_KEY4, "key_4", CHARACTERISTIC_FORMAT_INT, CHARACTERISTIC_PERMS_RT, 1, 2, 1));
	MDF_ERROR_ASSERT(mlink_add_characteristic(DEVICE_CID_KEY5, "key_5", CHARACTERISTIC_FORMAT_INT, CHARACTERISTIC_PERMS_RT, 1, 2, 1));
